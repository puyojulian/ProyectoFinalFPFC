...
val resultadoguia = reconstruirCadenaIngenuo(s1_8.length, crearOraculo(costoOraculo)(s1_8))
val resultadoguia1 = reconstruirCadenaIngenuoPar(1)(s1_8.length, crearOraculo(costoOraculo)(s1_8))

val resultadoguia = reconstruirCadenaMejorado(s3_32.length, crearOraculo(costoOraculo)(s3_32))
val resultadoguia1 = reconstruirCadenaMejoradoPar(1)(s3_32.length, crearOraculo(costoOraculo)(s3_32))
